public class SalaryManagement {
    ...
    public ShopAssistant[] fillShopAssistantToSalaryManagement(){
        ...
        for (int i=0;i< shopAssistantsCopy.length;i++){
            ...
            double totalRevenueFromOneAssistant=totalRevenueFromOneAssistant(transactions[i]);
    ...
    public  double totalRevenueFromOneAssistant(Transaction[] transactionsCopy){
        int i=0;
        double totalRevenueFromOneAssistant=0;
        for (int k=0;k<15;k++){
            totalRevenueFromOneAssistant+=transactionsCopy[k].getTotalPrice()+transactionsCopy[k].getTransactionFee();
        }
        return totalRevenueFromOneAssistant;
    }
}
